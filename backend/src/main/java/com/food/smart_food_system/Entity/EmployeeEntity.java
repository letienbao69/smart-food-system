...
public class EmployeeEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "position_id", nullable = false) private EmployeePositionEntity position;
    ...
    public EmployeePositionEntity getPosition(){return position;} public void setPosition(EmployeePositionEntity position){this.position=position;}
